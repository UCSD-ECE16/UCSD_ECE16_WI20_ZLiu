...
def main():
    sleep(20)
    data_array_from_file = np.genfromtxt('/Users/iris/UCSD_ECE16_WI20_ZLiu/src/Python/Lab4/Data_06_.csv', delimiter=',')
    time = data_array_from_file[:,0]
    o_signal = (-1)*data_array_from_file[:,4]
    # print(o_signal)
    plotting(time, o_signal);
    # print(signal)
    n = calc_heart_rate_time(o_signal,1000/19.97)
    print(n)
